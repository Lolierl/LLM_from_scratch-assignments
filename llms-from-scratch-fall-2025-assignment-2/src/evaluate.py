...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--model", default="/root/code/LLM_from_scratch-assignments/llms-from-scratch-fall-2025-assignment-2/custom_model_hf", help="Path to HF model directory")
    ap.add_argument(
        "--tokenizer",
        default="/thullms/publib/Qwen/Qwen3-0.6B-Base",
        help="Tokenizer path (default: /thullms/publib/Qwen/Qwen3-0.6B-Base)",
    )
    ap.add_argument("--hellaswag-root", default="/thullms/publib/data/Hellaswag", help="HellaSwag data directory")
    ap.add_argument("--lambada-root", default="/thullms/publib/data/cimec_lambada", help="LAMBADA data directory")
    ap.add_argument("--arc-file", default="/thullms/publib/data/ai2_arc/ARC-Easy/test-00000-of-00001.parquet", help="ARC-Easy parquet file")
